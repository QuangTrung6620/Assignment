...
namespace T1809E_UWP_DAPI
{
    ...
    public sealed partial class RegisterPage : Page
    {
        ...
        private async void SubmitData(HttpContent contentToSend)
        {
            ...
            Debug.WriteLine( returnMember.firstName);
            Debug.WriteLine(returnMember.lastName);
            Debug.WriteLine( returnMember.address);
            Debug.WriteLine(returnMember.email);
            Debug.WriteLine(returnMember.password);
        }
